      ...
      <div className="max-w-3xl space-y-6">
        <section>
          ...
          <p className="text-gray-600">
            We offer fast and reliable shipping to all locations. Standard
            delivery takes 3-5 business days, while express delivery is
        ...
        <section>
          ...
          <p className="text-gray-600">
            Free shipping is available for orders over $100. All other orders
            will be charged a flat rate shipping fee.
          </p>
        </section>
        <section>
