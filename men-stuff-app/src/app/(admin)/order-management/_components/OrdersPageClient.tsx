...
import { useAdminOrders } from '@/hooks/useGetAdminOrders'
    ...
    <div className="space-y-6">
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="font-mono text-[11px] tracking-widest text-slate-500 uppercase">Vận hành cửa hàng</p>
            <h1 className="mt-1 text-3xl font-bold tracking-tight text-slate-900">Đơn hàng</h1>
            <p className="mt-2 max-w-2xl text-sm text-slate-600">Danh sách đơn hàng mới nhất. Lọc theo trạng thái, tìm theo mã đơn / SĐT / tên người nhận, rồi cập nhật trạng thái xử lý.</p>
          </div>
