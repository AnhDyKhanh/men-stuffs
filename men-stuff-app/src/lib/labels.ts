...
export const labels = {
  ...
  admin: {
    ...
    tasksPage: {
      ...
      subtitle:
        'Theo dõi việc được giao. Lọc theo trạng thái, tìm theo tiêu đề / mô tả, hoặc chỉ xem việc của bạn; cập nhật tiến độ trực tiếp trên bảng.',
      backDashboard: 'Về dashboard',
      filterStatus: 'Trạng thái',
      allStatuses: 'Tất cả',
      mineOnly: 'Việc của tôi',
      allTasks: 'Tất cả việc',
      scope: 'Phạm vi',
      searchPlaceholder: 'Tiêu đề, mô tả…',
      searchButton: 'Tìm',
      refresh: 'Làm mới',
      tableTitle: 'Danh sách công việc',
      colTitle: 'Tiêu đề',
      colType: 'Loại',
      colStatus: 'Trạng thái',
      colOrder: 'Đơn liên quan',
      colAssignee: 'Người được giao',
      colDescription: 'Mô tả',
      colCreated: 'Thời gian',
      empty: 'Chưa có công việc nào khớp bộ lọc.',
      pageInfo: 'Hiển thị {from}–{to} / {total} việc',
    },
  },
} as const
